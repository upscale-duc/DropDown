...
public final class DropDown: UIView {
    ...
    /// The table footer view
        public var footerView: UIView? {
            didSet {
                setNeedsUpdateConstraints()
                tableView.sectionFooterHeight = footerViewHeight
            }
        }
        /// The table footer view height
...
//        heightConstraint.constant = layout.visibleHeight
        heightConstraint.constant = layout.visibleHeight + headerViewHeight + footerViewHeight
